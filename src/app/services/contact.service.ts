...
import { LoadingContacts } from '../store/actions/item.actions';
...
export class ContactService {
  ...
  query(filterBy = ''): Observable<Contact[]> {
    ...
    return from(storageService.query(ENTITY) as Promise<Contact[]>);
  ...
  save(contact: Contact): Observable<Contact> {
    ...
    const prmSavedItem = storageService[method](ENTITY, contact)
    console.log('ItemService: Saving Item ===> effect');
    return from(prmSavedItem) as Observable<Contact>
  }
